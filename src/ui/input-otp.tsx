...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        // ✅ fixed fallback for colors and rings
        "relative flex h-9 w-9 items-center justify-center text-sm transition-all outline-none " +
          ...
          "bg-white dark:bg-input/30 border-[var(--input-border,#D1D5DB)] " +
          "data-[active=true]:z-10 data-[active=true]:ring-[3px] " +
          "data-[active=true]:border-[var(--ring,_#5B9BD5)] data-[active=true]:ring-[var(--ring,_#5B9BD5)]/50 " +
